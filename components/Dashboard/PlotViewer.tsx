...
export default function PlotViewer({
    ...
    useEffect(() => {
        ...
        const newGridHelper = new THREE.GridHelper(groundSize, groundSize, 0x000000, 0x000000);
    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl border border-emerald-100 overflow-hidden">
            ...
            <div className="p-4 border-b border-emerald-100 bg-gradient-to-r from-emerald-50 to-teal-50">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-gray-800">Benim Arsam</h3>
            ...
            <div
                ref={containerRef}
                className={`bg-sky-200 ${isFullscreen ? 'h-[calc(100vh-250px)]' : 'h-[500px]'}`}
            />
