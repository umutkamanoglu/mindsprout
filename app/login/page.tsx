                ...
                <div className="hidden lg:flex flex-col justify-center space-y-8 p-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-xl text-gray-600 leading-relaxed">
                            Arsanı büyütmeye kaldığın yerden devam et. Yeni başarımlar ve ödüller seni bekliyor!
                        </p>
                    </div>
                    ...
                    <div className="relative">
                        <div className="w-full h-64 bg-linear-to-br from-emerald-500/20 to-teal-500/20 rounded-3xl flex items-center justify-center backdrop-blur-sm border border-emerald-200">
                            <div className="text-center">
                                ...
                                <p className="text-gray-700 font-semibold">Arsanı Keşfetmeye Devam Et</p>
                            </div>
                        </div>
                ...
                <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-12 border border-emerald-100">
                    ...
                    <div className="space-y-5">
                        ...
                        <button
                            ...
                            className="w-full bg-linear-to-r from-emerald-500 to-teal-500 text-white py-3.5 rounded-xl font-semibold hover:shadow-lg hover:scale-[1.02] transition-all flex items-center justify-center gap-2 group"
                        >
                            Giriş Yap
